...
public class OpenChatController {
     ...
     */
    @PostMapping
    public ResponseEntity<ApiResponse<OpenChatDto>> createChatRoom(@RequestBody CreateChatRoomDto createDto) {
     ...
     */
    @GetMapping("/{chatId}")
    public ResponseEntity<ApiResponse<OpenChatDto>> getChatRoomInfo(@PathVariable Long chatId) {
    ...
    public ResponseEntity<ApiResponse<Void>> joinChatRoom(@PathVariable Long chatId, @RequestBody JoinChatRoomDto joinDto) {
    ...
    public ResponseEntity<ApiResponse<Void>> leaveChatRoom(@PathVariable Long chatId, @RequestBody LeaveChatRoomDto leaveDto) {
    ...
    public ResponseEntity<ApiResponse<MessageDto>> sendMessage(@PathVariable Long chatId, @RequestBody SendMessageDto messageDto) {
     ...
     */
    @GetMapping("/search")
    public ResponseEntity<ApiResponse<List<OpenChatDto>>> searchChatRooms(@RequestParam String keyword) {
     ...
     */
    @PutMapping("/{chatId}")
    public ResponseEntity<ApiResponse<OpenChatDto>> updateChatRoom(@PathVariable Long chatId, @RequestBody UpdateChatRoomDto updateDto) {
    ...
    public ResponseEntity<ApiResponse<Void>> deleteChatRoom(@PathVariable Long chatId) {
